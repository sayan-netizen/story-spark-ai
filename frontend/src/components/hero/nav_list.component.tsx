    ...
    <>
      ...
      <header className="sticky top-0 z-50 w-full">
        ...
        <div className="relative mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          {/* Right side: SearchBar + ⌘K hint + theme + auth */}
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              {/* Search bar (desktop) + mobile icon */}
              <SearchBar />
              ...
              <button
                ...
                className="hidden items-center gap-1.5 rounded-full border border-slate-200/80 bg-white/60 px-3 py-2 text-xs font-semibold text-slate-500 shadow-sm transition-all hover:bg-white hover:text-slate-700 dark:border-white/10 dark:bg-white/[0.06] dark:text-slate-400 dark:hover:bg-white/10 dark:hover:text-slate-200 lg:flex"
                ...
                <div className="space-y-2 rounded-2xl border border-slate-200/70 bg-white/55 p-2 shadow-sm shadow-slate-900/5 dark:border-white/10 dark:bg-white/[0.04]">
                  ...
                  >
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold text-slate-700 transition-all duration-300 hover:bg-slate-100/80 dark:text-slate-300 dark:hover:bg-white/10"
                    >
